/**
 * EnrichmentScreen — main screen that aggregates all enrichments for a file.
 *
...
import { loadComments, loadEnrichments } from '../../actions/enrichmentActions';
...
export const EnrichmentScreen: React.FC<EnrichmentScreenProps> = ({
  sourceUri,
  selectedLines,
